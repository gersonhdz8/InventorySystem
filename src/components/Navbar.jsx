            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-slate-900 to-black h-20 ">
                <div className="flex justify-between justify-items-center max-w-screen-xl gap-1 h-full">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <Link to="/userRegister" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-indigo-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Get started</Link>
